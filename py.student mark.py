...
class StudentMarkListApp:
    ...
    def create_widgets(self):
        ...
        tk.Label(self.root, text="roll no").grid(row=1, column=0, padx=10, pady=5)
        self.roll_entry = tk.Entry(self.root)
        self.roll_entry.grid(row=1, column=1, padx=10, pady=5)
        
        
        self.subjects = ["Business analytics", "Machine learning", "analysis", "Social network", "Python programming"]
        self.mark_entries = []
        ...
        self.tree = ttk.Treeview(self.root, columns=("Name", "Roll No", *self.subjects, "Total", "Average"), show='headings')
